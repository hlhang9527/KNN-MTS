...
class STEPRunner(BaseTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, train:bool = True, **kwargs) -> tuple:
        ...
        # feed forward
        prediction, pred_adj, prior_adj, gsl_coefficient, step_hiddens = self.model(history_data=history_data, long_history_data=long_history_data, future_data=None, batch_seen=iter_num, epoch=epoch)
        ...
        return prediction, real_value, pred_adj, prior_adj, gsl_coefficient, step_hiddens